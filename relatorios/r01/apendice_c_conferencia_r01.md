# Apêndice C — Relatório de Conferência da Rodada r01
...
| Com nota AMAWeb | 356 | 98,34% |
| Com nota AccessMonitor | 355 | 98,07% |
| Com ambas as notas | 351 | 96,96% |
...
**Resultado:** Atendido.  
**Síntese do cálculo:** Notas AMAWeb preenchidas: 356; notas AccessMonitor preenchidas: 355; notas fora da faixa 0–10: 0.
...
**Resultado:** Atendido.  
**Síntese do cálculo:** Falhas críticas — AMAWeb: 0 (0,00%); AccessMonitor: 0 (0,00%); Sistema: 0 (0,00%). Limite: < 5,00%.

### 4.10 Critério 10 — Viabilidade dos cálculos previstos na análise

**Resultado:** Atendido.  
**Síntese do cálculo:** Colunas obrigatórias ausentes — base: 0, execuções: 0, logs: 0. Observações válidas — AMAWeb: 356, AccessMonitor: 355, pares AMAWeb+AccessMonitor: 351.
...
| Notas válidas AMAWeb | 356 |
| Notas válidas AccessMonitor | 355 |
| Pares válidos AMAWeb + AccessMonitor | 351 |
...
A rodada oficial `r01` foi considerada **APROVADA**, pois todos os critérios obrigatórios de conferência foram atendidos. Com isso, os dados da rodada podem ser mantidos no conjunto analítico da pesquisa, preservada sua identificação por rodada, ferramenta, município e status de coleta.
