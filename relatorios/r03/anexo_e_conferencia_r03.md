# Anexo E — Relatório de Conferência da Rodada r03
...
**Resultado:** Atendido.  
**Síntese do cálculo:** Notas AMAWeb preenchidas: 355; notas AccessMonitor preenchidas: 355; notas fora da faixa 0–10: 0.
...
**Resultado:** Atendido.  
**Síntese do cálculo:** Colunas obrigatórias ausentes — base: 0, execuções: 0, logs: 0. Observações válidas — AMAWeb: 355, AccessMonitor: 355, pares AMAWeb+AccessMonitor: 351.
...
A rodada oficial `r03` foi considerada **APROVADA**, pois todos os critérios obrigatórios de conferência foram atendidos. Com isso, os dados da rodada podem ser mantidos no conjunto analítico da pesquisa, preservada sua identificação por rodada, ferramenta, município e status de coleta.
